...
<body>
    ...
    <a href="{{route('logout')}}" style="text-align: left;"><b>Logout</b></a>

    <a href="{{route('travel')}}" class="btn btn-success" style="float:right;background-color: orange;">Create
        Bookings</a>

    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
            <form class="form-inline my-2 my-ls-0" type="get" action="{{route('searchorders')}}">
